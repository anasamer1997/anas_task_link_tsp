...
import 'package:rick_and_morty_explorer/features/characters/presentation/details_page/cubit/character_details_cubit.dart';

class CharacterDetailsPage extends StatelessWidget {
  const CharacterDetailsPage({super.key});

  static Route<void> route({required CharacterModel character}) {
